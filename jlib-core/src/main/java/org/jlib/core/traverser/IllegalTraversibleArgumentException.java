...
extends IllegalJlibArgumentException {
     ...
     */
    public IllegalTraversibleArgumentException(final Traversible<?> traversible, final String messagePattern, final Object... messageArguments) {
     ...
     *        sequence of {@link Object} message arguments
     */
    public IllegalTraversibleArgumentException(final Traversible<?> traversible, final String messagePattern, final Throwable cause, final Object... messageArguments) {
