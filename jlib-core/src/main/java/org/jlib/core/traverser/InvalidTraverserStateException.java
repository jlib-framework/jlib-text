...
extends InvalidStateException {
     ...
     */
    public InvalidTraverserStateException(final Traversible<?> traversible, final ParametrizedMessage parametrizedMessage) {
        super(parametrizedMessage, traversible);
