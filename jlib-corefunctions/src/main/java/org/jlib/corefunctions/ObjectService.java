...
public class ObjectService {
    ...
    throws ServiceConfigurationError, NoObjectSpiImplementationException,
        ...
        assertExactlyOneSpiInClassPath(coreFunctionsDispatchers);

        coreFunctionsDispatcher = coreFunctionsDispatchers.get(0);
    }

    private void assertExactlyOneSpiInClassPath(final List<CoreFunctionsDispatcher> coreFunctionsDispatchers)
