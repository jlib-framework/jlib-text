...
public abstract class SequenceCreator<Seq extends Sequence<Element>, Element> {
     ...
     * 
     * @param firstIndex
     *        integer specifying the first index of the Sequence
     * 
     * @param lastIndex
     *        integer specifying the last index of the Sequence
     * 
     * @throws IllegalArgumentException
     *         if {@code firstIndex < 0 || lastIndex < firstIndex}
     */
    public Seq ArraySequence(final int firstIndex, final int lastIndex)
    throws IllegalArgumentException {
        NonEmptyArraySequence<Element> delegateSequence = new NonEmptyArraySequence<>(firstIndex, lastIndex);
    }
    ...
    public abstract Seq createSequence();
}
