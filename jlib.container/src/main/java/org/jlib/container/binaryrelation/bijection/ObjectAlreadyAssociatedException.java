...
import org.jlib.container.binaryrelation.IllegalBinaryRelationArgumentException;
...
extends IllegalBinaryRelationArgumentException {
     ...
     *        {@code binaryRelation}
     */
    public ObjectAlreadyAssociatedException(final BinaryRelation<?, ?> binaryRelation, final Object object) {
        super();
