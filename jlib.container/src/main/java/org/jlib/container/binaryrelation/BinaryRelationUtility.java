...
public class BinaryRelationUtility {
    ...
    throws AssociationAlreadyContainedException, IllegalBinaryRelationArgumentException {
        if (binaryRelation.isContaining(association))
     ...
     */
    // @formatter:off
    public static <LeftValue, RightValue, Associations extends Iterable<? extends Association<LeftValue, RightValue>>> 
                  void associate(final AssociateBinaryRelation<LeftValue, RightValue> binaryRelation, final Associations associations) {
    // @formatter:on
    ...
    @SafeVarargs
    public static <LeftValue, RightValue> void associate(final AssociateBinaryRelation<LeftValue, RightValue> binaryRelation,
                                                         final Association<LeftValue, RightValue>... associations) {
     ...
     *        {@link Iterable} providing the Associations to associate
     */
    public static <LeftValue, RightValue> void assertContained(final AssociateBinaryRelation<LeftValue, RightValue> binaryRelation,
                                                               final Iterable<? extends Association<LeftValue, RightValue>> associations) {
     ...
     */
    @SafeVarargs
    public static <LeftValue, RightValue, RetainedAssociation extends Association<LeftValue, RightValue>> void retain(final RemoveBinaryRelation<LeftValue, RightValue> binaryRelation,
