...
extends IllegalContainerArgumentException {
     ...
     */
    public IllegalBinaryRelationArgumentException(final BinaryRelation<?, ?> binaryRelation, final String messagePattern, final Object... messageArguments) {
     ...
     *        sequence of {@link Object} parameters of the error message
     */
    public IllegalBinaryRelationArgumentException(final BinaryRelation<?, ?> binaryRelation, final String messagePattern, final Throwable cause, final Object... messageArguments) {
